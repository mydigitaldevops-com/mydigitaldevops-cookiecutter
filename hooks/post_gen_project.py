...
def remove_docker_files():
    ...
    file_names = ["dev.yml", "prod.yml", ".dockerignore"]
    for file_name in file_names:
        os.remove(file_name)
...
def remove_celery_files():
    file_names = [
        os.path.join("config", "celery", "main.py"),
...
def set_flags_in_settings_files():
    ...
    set_django_secret_key(os.path.join("config", "tests", "test_main.py"))
...
def remove_celery_compose_dirs():
    shutil.rmtree(os.path.join("compose", "dev", "django", "celery"))
    shutil.rmtree(os.path.join("compose", "prod", "django", "celery"))


def remove_node_dockerfile():
    shutil.rmtree(os.path.join("compose", "dev", "node"))


def remove_aws_dockerfile():
    shutil.rmtree(os.path.join("compose", "prod", "aws"))


def remove_drf_starter_files():
    os.remove(os.path.join("config", "api", "router.py"))
