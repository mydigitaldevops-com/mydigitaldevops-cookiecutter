...
# TODO: set this to 60 seconds first and then to 518400 once sure it works
...
COMPRESS_URL = STATIC_URL{% if cookiecutter.use_whitenoise == 'y' or cookiecutter.cloud_provider == 'None' %}  # noqa
# F405{% endif %}
{%- if cookiecutter.use_whitenoise == 'y' %}
